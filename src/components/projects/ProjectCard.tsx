      ...
      <div className="flex flex-col flex-1 p-3">
        ...
        <div className="flex items-center gap-2 flex-wrap mb-2 min-h-[1.5rem]">
          ...
          {project.cofinancingAvailable === 'YES' && (
            <span className="group inline-flex items-center gap-1.5 h-6 rounded-full bg-green-100 text-green-600 px-2 transition-all duration-300 ease-out hover:px-2.5">
              <svg
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
