        ...
        <div className="flex items-center gap-2 flex-wrap mb-2 min-h-[1.5rem]">
          ...
          {project.cofinancingAvailable === 'YES' && (
            <span className="relative group">
              ...
              <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 text-xs font-medium text-white bg-[var(--navy-700)] rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
