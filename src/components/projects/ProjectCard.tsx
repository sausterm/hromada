      ...
      <div className="flex flex-col flex-1 p-3">
        ...
        <div className="flex items-center gap-2 flex-wrap mb-2 min-h-[1.5rem]">
          ...
          {project.cofinancingAvailable === 'YES' && (
            <span className="group inline-flex items-center justify-center gap-1 h-6 w-6 rounded-full bg-green-100 text-green-600 transition-all duration-300 ease-out hover:w-auto hover:px-2.5 hover:gap-1.5">
              <svg
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="w-3.5 h-3.5 flex-shrink-0 transition-transform duration-500 group-hover:rotate-[360deg]"
              >
              ...
              <span className="text-xs font-medium whitespace-nowrap max-w-0 overflow-hidden transition-all duration-300 ease-out group-hover:max-w-[150px]">
